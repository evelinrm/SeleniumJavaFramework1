...
import java.net.URL;
public class junittestsaucelabs1 {
    ...
    public void shouldOpenSafari() throws MalformedURLException {
        ...
        capabilities.setCapability("eramos", sauceUserName);

        //set your sauce labs access key
        capabilities.setCapability("c0735e73-26fc-4836-a179-d51cc00ab065", sauceAccessKey);
